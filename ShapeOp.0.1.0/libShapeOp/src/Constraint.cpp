...
SHAPEOP_INLINE Matrix33 createRotationMatrix(Vector3 rotationAxis, Scalar angle){
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE Matrix3X EdgeStrainConstraint::getProjection(const Matrix3X &positions) const
{
    Matrix3X projection;
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE CotangentLaplacianConstraint::CotangentLaplacianConstraint(const std::vector<int> &idI, Scalar weight, const Matrix3X &positions, bool displacement_lap) :
    Constraint(idI, weight)
{
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void CotangentLaplacianConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void CotangentLaplacianConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    idO_ = idO;
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE RegressionPlaneOrientationConstraint::RegressionPlaneOrientationConstraint(const std::vector<int> &idI,
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void RegressionPlaneOrientationConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
    for(unsigned int i = 0; i < nIndices(); i++)
        projections.col(idO_ + i) = weight_ * projection.col(i);
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void RegressionPlaneOrientationConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    //Store this constraints position in the global linear system
    idO_ = idO;
    //Precompute coefficients for mean-centering
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void RegressionPlaneOrientationConstraint::setOrientation(const Vector3 &normal)
{
    normal_ = normal;
    normal_.normalize();
}
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE PolylineLengthConstraint::PolylineLengthConstraint(const std::vector<int> &idI,
                                                                  Scalar weight,
                                                                  const Matrix3X &positions,
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void PolylineLengthConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
    for(unsigned int i = 0; i < nIndices(); i++)
        projections.col(idO_ + i) = weight_ * projection.col(i);
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void PolylineLengthConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    //Store this constraints position in the global linear system
    idO_ = idO;
    //Precompute coefficients for mean-centering
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE Scalar PolylineLengthConstraint::getRangeMin() const
{
    return rangeMin_;
}

///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void PolylineLengthConstraint::setRangeMin(const Scalar &value)
{
    rangeMin_ = value;
}

///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE Scalar PolylineLengthConstraint::getRangeMax() const
{
    return rangeMax_;
}

///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void PolylineLengthConstraint::setRangeMax(const Scalar &value)
{
    rangeMax_ = value;
}

///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE RectangleFitConstraint::RectangleFitConstraint(const std::vector<int> &idI, Scalar weight, const Matrix3X &positions) :
    Constraint(idI, weight)
{
    assert(idI.size() >= 4);
    input = Matrix3X::Zero(3, idI.size());
...
SHAPEOP_INLINE bool areEqual(double a, double b){
    bool result = false;
...
SHAPEOP_INLINE bool isALessThanB(std::pair<std::pair<double, double>, unsigned int> a,
...
SHAPEOP_INLINE bool isLeft(Vector3 p, Vector3 p1, Vector3 p2){
    return (p(0) - p1(0)) * (p2(1) - p1(1)) - (p(1) - p1(1)) * (p2(0) - p1(0)) < 0;
}

SHAPEOP_INLINE Vector3 pointLineProjection(Vector3 a, Vector3 b, Vector3 c){
 ...
 * @return the distance
 */
SHAPEOP_INLINE double pointLineDistance(Vector3 a, Vector3 b, Vector3 c){
    return (c - a).cross(c - b).norm() / (b - a).norm();
}

SHAPEOP_INLINE bool isPointInSegment(Vector3 a, Vector3 b, Vector3 p)
{
    double l = (b - a).norm();
    double l1 = (p - a).norm();
    double l2 = (b - p).norm();
...
SHAPEOP_INLINE Vector3 computeLineIntersection(Vector3 v1, Vector3 p1, Vector3 v2, Vector3 p2){
    double x;
    double a, b, c, d;
 ...
 */
SHAPEOP_INLINE std::vector<Vector3> extractConvexHull(MatrixX3 points){
 ...
 * @return
 */
SHAPEOP_INLINE MatrixX3 getMBR(MatrixX3 points){
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void RectangleFitConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void RectangleFitConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    //Store this constraints position in the global linear system
    idO_ = idO;
    //Precompute coefficients for mean-centering
...
SHAPEOP_INLINE Matrix3X RectangleFitConstraint::getProjection(const Matrix3X &positions) const
{
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE EquilateralConstraint::EquilateralConstraint(const std::vector<int> &idI, Scalar weight, const Matrix3X &positions) :
    Constraint(idI, weight){
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void EquilateralConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
    for(unsigned int i = 0; i < nIndices(); i++)
        projections.col(idO_ + i) = projection.col(i) * weight_;
...
///////////////////////////////////////////////////////////////////////////////
SHAPEOP_INLINE void EquilateralConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    //Store this constraints position in the global linear system
    idO_ = idO;
    //Precompute coefficients for mean-centering
...
SHAPEOP_INLINE Matrix3X EquilateralConstraint::getProjection(const Matrix3X &positions) const
{
...
SHAPEOP_INLINE SimilarLengthConstraint::SimilarLengthConstraint(const std::vector<int> &idI, Scalar weight, const Matrix3X &positions, Scalar minProportion, Scalar maxProportion):
    Constraint(idI, weight),
...
SHAPEOP_INLINE SimilarLengthConstraint::~SimilarLengthConstraint(){}

SHAPEOP_INLINE void SimilarLengthConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
    projections.block(0, idO_, 3, linePointsCardinality1+linePointsCardinality2) = projection * weight_;
}

SHAPEOP_INLINE void SimilarLengthConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    //Store this constraints position in the global linear system
    idO_ = idO;
    //Precompute coefficients for mean-centering
...
SHAPEOP_INLINE Matrix3X SimilarLengthConstraint::getProjection(const Matrix3X &positions) const
{
...
SHAPEOP_INLINE unsigned int SimilarLengthConstraint::getLinePointsCardinality1() const
{
    return linePointsCardinality1;
}

SHAPEOP_INLINE void SimilarLengthConstraint::setLinePointsCardinality1(unsigned int value)
{
    linePointsCardinality1 = value;
}

SHAPEOP_INLINE unsigned int SimilarLengthConstraint::getLinePointsCardinality2() const
{
    return linePointsCardinality2;
}

SHAPEOP_INLINE void SimilarLengthConstraint::setLinePointsCardinality2(unsigned int value)
{
    linePointsCardinality2 = value;
}

SHAPEOP_INLINE double SimilarLengthConstraint::getMinProportion() const
{
    return minProportion_;
}

SHAPEOP_INLINE void SimilarLengthConstraint::setMinProportion(double value)
{
    minProportion_ = value;
}

SHAPEOP_INLINE std::size_t SimilarLengthConstraint::nIndices() const
{
    return idI_.size();
}

SHAPEOP_INLINE double SimilarLengthConstraint::getMaxProportion() const
{
    return maxProportion_;
}

SHAPEOP_INLINE void SimilarLengthConstraint::setMaxProportion(double value)
{
    maxProportion_ = value;
}

SHAPEOP_INLINE NonUniformScalingConstraint::NonUniformScalingConstraint(const std::vector<int> &idI, Scalar weight, const Matrix3X &positions, Scalar minProportion, Scalar maxProportion, int l1StartIndex, int l1EndIndex, int l2StartIndex, int l2EndIndex, bool l1directed, bool l2directed, Vector3 direction1, Vector3 direction2):
    Constraint(idI, weight),
    minProportion_(minProportion),
    maxProportion_(maxProportion),
...
SHAPEOP_INLINE NonUniformScalingConstraint::~NonUniformScalingConstraint()
{

}

SHAPEOP_INLINE void NonUniformScalingConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
    projections.block(0, idO_, 3, input.cols()) = projection * weight_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    //Store this constraints position in the global linear system
    idO_ = idO;
    //Precompute coefficients for mean-centering
...
SHAPEOP_INLINE Matrix3X NonUniformScalingConstraint::getProjection(const Matrix3X &positions) const
{
    Matrix3X projection;
...
SHAPEOP_INLINE double NonUniformScalingConstraint::getMinProportion() const
{
    return minProportion_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::setMinProportion(double minProportion)
{
    minProportion_ = minProportion;
}

SHAPEOP_INLINE double NonUniformScalingConstraint::getMaxProportion() const
{
    return maxProportion_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::setMaxProportion(double maxProportion)
{
    maxProportion_ = maxProportion;
}

SHAPEOP_INLINE int NonUniformScalingConstraint::getL1StartIndex() const
{
    return l1StartIndex_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::setL1StartIndex(int l1StartIndex)
{
    l1StartIndex_ = l1StartIndex;
}

SHAPEOP_INLINE int NonUniformScalingConstraint::getL1EndIndex() const
{
    return l1EndIndex_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::setL1EndIndex(int l1EndIndex)
{
    l1EndIndex_ = l1EndIndex;
}

SHAPEOP_INLINE int NonUniformScalingConstraint::getL2StartIndex() const
{
    return l2StartIndex_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::setL2StartIndex(int l2StartIndex)
{
    l2StartIndex_ = l2StartIndex;
}

SHAPEOP_INLINE int NonUniformScalingConstraint::getL2EndIndex() const
{
    return l2EndIndex_;
}

SHAPEOP_INLINE void NonUniformScalingConstraint::setL2EndIndex(int l2EndIndex)
{
    l2EndIndex_ = l2EndIndex;
}
...
SHAPEOP_INLINE CoaxialityConstraint::CoaxialityConstraint(const std::vector<int> &idI, Scalar weight, const Matrix3X &positions, Scalar minValue, Scalar maxValue, unsigned int firstSetSize, unsigned int secondSetSize) :
    Constraint(idI, weight),
    minValue_(minValue),
    maxValue_(maxValue),
...
SHAPEOP_INLINE void CoaxialityConstraint::project(const Matrix3X &positions, Matrix3X &projections) const
{
    Matrix3X projection = getProjection(positions);
    for(unsigned int i = 0; i < nIndices(); i++)
        projections.col(idO_ + i) = weight_ * projection.col(i);
...
SHAPEOP_INLINE void CoaxialityConstraint::addConstraint(std::vector<Triplet> &triplets, int &idO) const
{
    idO_ = idO;
    double coef1 = (1.0 - 1.0 / nIndices()) * weight_;
    double coef2 = - weight_ / nIndices();
...
SHAPEOP_INLINE std::pair<unsigned int, std::vector<Vector3>> CoaxialityConstraint::sphere_line_intersection (Vector3 p1, Vector3 p2, Vector3 p3, double r, bool inSegment) const
{
...
SHAPEOP_INLINE Matrix3X CoaxialityConstraint::extractSkeleton(std::vector<unsigned int> seedLoop) const
{
...
SHAPEOP_INLINE Matrix3X CoaxialityConstraint::getProjection(const Matrix3X &positions) const
{
    int edge_flag = EDGE_FLAGGED;
...
SHAPEOP_INLINE double CoaxialityConstraint::getMinValue() const
{
    return minValue_;
}

SHAPEOP_INLINE void CoaxialityConstraint::setMinValue(double minValue)
{
    minValue_ = minValue;
}

SHAPEOP_INLINE double CoaxialityConstraint::getMaxValue() const
{
    return maxValue_;
}

SHAPEOP_INLINE void CoaxialityConstraint::setMaxValue(double maxValue)
{
    maxValue_ = maxValue;
}

SHAPEOP_INLINE unsigned int CoaxialityConstraint::getFirstSetSize() const
{
    return firstSetSize_;
}

SHAPEOP_INLINE void CoaxialityConstraint::setFirstSetSize(unsigned int value)
{
    firstSetSize_ = value;
}

SHAPEOP_INLINE unsigned int CoaxialityConstraint::getSecondSetSize() const
{
    return secondSetSize_;
}

SHAPEOP_INLINE void CoaxialityConstraint::setSecondSetSize(unsigned int value)
{
