...
#ifndef GRAPHENE_ENERGY_TERM_ORIGINAL_STRUCTURE_H
#define GRAPHENE_ENERGY_TERM_ORIGINAL_STRUCTURE_H
...
class
Energy_term_original_structure : public Energy_term
{
public:

    Energy_term_original_structure(const Energy_term_data& energy_term_data, double weight);

    virtual ~Energy_term_original_structure();
...
//=============================================================================
#endif // GRAPHENE_ENERGY_TERM_ORIGINAL_STRUCTURE_H
//=============================================================================
