...
#ifndef GRAPHENE_ENERGY_TERM_PCA_CPC_MESH2PS_H
#define GRAPHENE_ENERGY_TERM_PCA_CPC_MESH2PS_H
...
class
Energy_term_pca_cpc_mesh2ps : public Energy_term
{
private:

    std::vector<Correspondence> skinned_correspondences;

public:

    Energy_term_pca_cpc_mesh2ps(const Energy_term_data& energy_term_data, double weight);

    virtual ~Energy_term_pca_cpc_mesh2ps();
...
//=============================================================================
#endif // GRAPHENE_ENERGY_TERM_PCA_CPC_MESH2PS_H
//=============================================================================
