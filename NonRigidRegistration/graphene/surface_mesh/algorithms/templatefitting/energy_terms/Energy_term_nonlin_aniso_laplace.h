...
#ifndef GRAPHENE_ENERGY_TERM_NONLIN_ANISO_LAPLACE_H
#define GRAPHENE_ENERGY_TERM_NONLIN_ANISO_LAPLACE_H
...
class
Energy_term_nonlin_aniso_laplace : public Energy_term
{
public:

    Energy_term_nonlin_aniso_laplace(const Energy_term_data& energy_term_data, double weight);

    virtual ~Energy_term_nonlin_aniso_laplace();
...
//=============================================================================
#endif // GRAPHENE_ENERGY_TERM_NONLIN_ANISO_LAPLACE_H
//=============================================================================
