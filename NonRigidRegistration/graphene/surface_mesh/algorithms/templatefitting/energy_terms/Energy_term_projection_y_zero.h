...
#ifndef GRAPHENE_ENERGY_TERM_PROJECTION_Y_ZERO_H
#define GRAPHENE_ENERGY_TERM_PROJECTION_Y_ZERO_H
...
class
Energy_term_projection_y_zero : public Energy_term
{
public:

    Energy_term_projection_y_zero(const Energy_term_data& energy_term_data, double weight);

    virtual ~Energy_term_projection_y_zero();
...
//=============================================================================
#endif // GRAPHENE_ENERGY_TERM_PROJECTION_Y_ZERO_H
//=============================================================================
