...
#ifndef GRAPHENE_ENERGY_TERM_PROJECTION_RIGHT_EYE_H
#define GRAPHENE_ENERGY_TERM_PROJECTION_RIGHT_EYE_H
...
class
Energy_term_projection_right_eye : public Energy_term
{
public:

    Energy_term_projection_right_eye(const Energy_term_data& energy_term_data, double weight);

    virtual ~Energy_term_projection_right_eye();
...
//=============================================================================
#endif // GRAPHENE_ENERGY_TERM_PROJECTION_RIGHT_EYE_H
//=============================================================================
