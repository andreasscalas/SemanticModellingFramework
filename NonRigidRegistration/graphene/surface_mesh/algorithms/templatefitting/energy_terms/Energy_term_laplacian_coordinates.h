...
#ifndef GRAPHENE_ENERGY_TERM_LAPLACIAN_COORDINATES_H
#define GRAPHENE_ENERGY_TERM_LAPLACIAN_COORDINATES_H
...
class
Energy_term_laplacian_coordinates : public Energy_term
{
public:

    Energy_term_laplacian_coordinates(const Energy_term_data& energy_term_data, double weight);

    virtual ~Energy_term_laplacian_coordinates();
...
//=============================================================================
#endif // GRAPHENE_ENERGY_TERM_LAPLACIAN_COORDINATES_H
//=============================================================================
