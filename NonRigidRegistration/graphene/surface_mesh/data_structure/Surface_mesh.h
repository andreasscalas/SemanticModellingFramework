//=============================================================================
// Copyright (C) 2011-2014 by Graphics & Geometry Group, Bielefeld University
...
public: //--------------------------------------------------- property handling
    ...
    /** get the halfedge property named \c name of type \c T. returns an invalid
     Halfedge_property if the property does not exist or if the type does not match. */
    ...
    /** get the edge property named \c name of type \c T. returns an invalid
     Edge_property if the property does not exist or if the type does not match. */
    ...
    /** get the face property named \c name of type \c T. returns an invalid
     Face_property if the property does not exist or if the type does not match. */
