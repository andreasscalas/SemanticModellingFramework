...
void SemanticGraphInteractionStyle::OnMouseMove()
{
    ...
    } else if (this->Interaction == SELECTING)
    {
        ...
        //AreaPicker->SetRenderer(this->GetCurrentRenderer());
        //int result = AreaPicker->AreaPick(this->StartPosition[0], this->StartPosition[1],
        //                                  this->EndPosition[0], this->EndPosition[1], this->GetCurrentRenderer());
        //if(result != 0){
