...
{
private:
    DrawableMesh* mesh;                                 //The model to deform
...
public:
     ...
     */
    ShapeOpMeanValueCoordinates(DrawableMesh* mesh, DrawableMesh* cage, ShapeOp::MatrixX3* meshVertices, ShapeOp::MatrixX3* cageVertices);
