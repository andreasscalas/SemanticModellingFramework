...
void GreenCoordinates::computeCoordinates(){
     ...
     * of the model)*/
    QString sv = coordsFileName;
    sv.append("_vertices.coord");
    ifstream myfile (sv.toStdString());
    ...
    if (!myfile.is_open()){
        ...
        for(uint t = 0; t < static_cast<uint>(NUM_THREADS); t++)
...
void GreenCoordinates::saveCoordinates(QString filename){
...
void GreenCoordinates::loadCoordinates(QString filename){
...
Eigen::MatrixXd GreenCoordinates::getCoordinates(){
