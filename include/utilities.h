...
namespace Utilities {
    ...
    //Eigen::MatrixX3d extractSkeleton(ExtendedTrimesh* mesh, std::vector<unsigned int> triangles, std::vector<Eigen::Vector3d> seedLoop);
    //Eigen::MatrixX3d extractSkeleton(ExtendedTrimesh* mesh, std::vector<unsigned int> triangles, std::vector<std::vector<unsigned int> > boundaries, unsigned int seedLoop);
