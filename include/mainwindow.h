...
private slots:
    ...
    void slotActionAddAnnotationsConstraint();
    ...
    /**
     * @brief slotTransfer Slot that manages the click on the "two statues" button. Transfer the annotations defined onto the current mesh onto another mesh representing the same object (different resolutions, vertexes positions).
     */
    void slotTransfer();

    void slotSelectAnnotations(bool checked);
    ...
    void slotAnnotationWindowClosed(DrawableMesh*);
...
private:
    ...
    vtkSmartPointer<AnnotationSelectionInteractorStyle> annotationSelectionStyle;
    ...
    std::vector<unsigned int> laplacianConstraintsID;
    ...
    void clearAnnotations(DrawableMesh*);
