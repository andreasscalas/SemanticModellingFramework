...
class DrawableMesh : public ExtendedTrimesh {
    ...
    public:
        ...
        unsigned int getAnnotationId(DrawableAnnotation*) const;

        std::vector<DrawableAnnotation *> getDAnnotations() const;

        void removeAnnotation(DrawableAnnotation* annotation);
protected:
        ...
        vtkSmartPointer<vtkCellArray> annotatedLines;
        ...
        vtkSmartPointer<vtkUnsignedCharArray> annotationsPColors;   //Array of colors of the annotated points
        vtkSmartPointer<vtkUnsignedCharArray> annotationsLColors;   //Array of colors of the annotated lines
        vtkSmartPointer<vtkUnsignedCharArray> annotationsTColors;   //Array of colors of the annotated triangles
        ...
        std::vector<DrawableAnnotation*> dAnnotations;
